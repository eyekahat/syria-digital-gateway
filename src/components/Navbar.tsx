...
import { Globe, Menu, X, User, Bell, Search, Moon, Sun } from "lucide-react";
          ...
          <div className="bg-syria-green text-white py-2 px-4 text-sm">
            <div className="container mx-auto flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <p>
                  {language === "ar"
                    ? "آخر الأخبار: تم إطلاق البوابة الرقمية السورية كنموذج تجريبي"
                    : "Latest news: Syrian Digital Gateway launched as a prototype"}
                </p>
              </div>
              <div className="flex items-center gap-2">
                <Button
          ...
          <div className="container mx-auto py-3 px-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center gap-6">
                <Link
                  to="/"
                  className="font-medium hover:text-syria-green transition-colors"
                >
          ...
          {isMenuOpen && (
            <div className="md:hidden bg-white border-t py-4 px-6">
              <nav className="flex flex-col space-y-4">
                <Link
                  to="/"
                  className="font-medium py-2 hover:text-syria-green transition-colors"
                  onClick={toggleMenu}
                >
                  {language === "ar" ? "الرئيسية" : "Home"}
                </Link>
